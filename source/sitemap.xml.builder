...
# Sitemap: http://iamlos.xyz/sitemap.xml
...
#
# Remember to exchange iamlos.github.io for your domain (line 64)
...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      xml.url do
        xml.loc 'http://iamlos.xyz' + page.url   # TODO: possibly remove .html
